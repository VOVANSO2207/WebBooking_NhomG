            ...
            <div class="payment-card">
                ...
                <div class="payment-header">
                    @if ($success)
                        ...
                        <h1 class="payment-title">Thanh toán thành công!</h1>
                ...
                <div class="payment-details">
                    <h2 class="details-title">Chi tiết giao dịch</h2>
                    <div class="details-list">
                        <div class="detail-item">
                            <span class="detail-label">Mã giao dịch:</span>
                            <span class="detail-value">{{ $inputData['vnp_TxnRef'] ?? 'N/A' }}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Số tiền:</span>
                            <span class="detail-value">{{ number_format($inputData['vnp_Amount'] / 100, 0, ',', '.') }}
                                VNĐ</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Nội dung thanh toán:</span>
                            <span class="detail-value">{{ $inputData['vnp_OrderInfo'] ?? 'N/A' }}</span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Thời gian:</span>
                            <span class="detail-value">
                                @php
                                    $date = isset($inputData['vnp_PayDate'])
                                        ? \Carbon\Carbon::createFromFormat('YmdHis', $inputData['vnp_PayDate'])
                                        : now();
