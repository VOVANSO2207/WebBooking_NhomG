            ...
            <div class="row">
                    ...
                    <form id="bookingForm">
                        ...
                        <div class="hotel-card border p-4">
                            <div class="row hotel-row">
                                ...
                                <div class="col-md-9 hotel-details">
                                    ...
                                    <div class="hotel-rating">
                                        ...
                                        @if ($hasHalfStar)
                                            <span style="position: relative; display: inline-block;">
                                                ...
                                                <span style="position: absolute; left: 0; overflow: hidden; width: 50%; color: gold;">★</span>
                                            </span>
                                        @endif
                                    ...
                                    <span class="lhotel-addresscation">{{$hotel->location}} , {{$hotel->city->city_name}}</span>
                                </div>
                            </div>
                            <hr>
                        ...
                        <div class="contact-form p-4 mt-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="full-name" class="form-control" value="{{ Auth::check() ? Auth::user()->username : 'Guest' }}">
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="email" class="form-label m-0">Email</label>
                                    <input type="email" id="email" class="form-control" value="{{ Auth::check() ? Auth::user()->email : 'email@example.com' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="phone" class="form-label m-0">Số điện thoại</label>
                                    <input type="tel" id="phone" class="form-control" value="{{ Auth::check() ? Auth::user()->phone_number : '0123456789' }}">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4 ">
                    <div class="room-info-card border">
                                ...
                                <div class="slides">
                                    @foreach ($room->room_images as $index => $image)
                                        <div class="slide {{ $index === 0 ? 'active' : '' }}">
                                            <img src="{{ asset('storage/images/' . $image->image_url) }}" alt="Image {{ $index + 1 }}">
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <hr class="m-0">
                        <div class="room-info-extra d-flex gap-4" style="padding: 15px 20px; margin:0;justify-content: space-between">
                            ...
                            <div class="room-type">
                                ...
                                <strong>Loại phòng:</strong> {{ $room->roomType->name }} <!-- Giả sử quan hệ với bảng room_types -->
                            </div>
                        </div>
                        <hr class="m-0">
                        ...
                        <div class="room-info-description">
                            ...
                            <p class="room-description">{!! $room->description !!}
                                <span><a href="#" class="detail-btn-load-more">Xem thêm</a></span> tầm nhìn ra đại
                                dương đẹp
                                nhất tại
                                thành phố
