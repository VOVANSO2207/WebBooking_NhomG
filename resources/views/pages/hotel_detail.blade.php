                    ...
                    <form id="searchForm" action="{{ route('hotels.search') }}" method="GET" class="row">
                        ...
                        <div class="col-md-3">
                            <div class="date-picker-search border">
                                ...
                                <input class="datepicker-staynest form-control p-0 ms-2" type="text"
                                    name="daterange" value="{{ session('daterange', '') }}" readonly />
                            </div>
                        </div>
                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card-room-btn-book">
                                                <form
                                                    ...
                                                    <button type="submit" class="btn-book-now" style="background: none; border: none; color: #fff; cursor: pointer;">Đặt ngay</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="box-review">
                <form class="group-input-review" id="reviewForm"
                    ...
                    <div class="group-text-review">
                        <input type="text" placeholder="Mời bạn nhập đánh giá..." class="form-control"
                            id="inputReview" name="comment" required>
                            ...
                            <div class="group-info-review">
                                ...
                                <div class="action-review mt-2">
                                    <a href="javascript:void(0)" class="like-review me-4"
                                        id="like-review-{{ $review->review_id }}"
