        ...
        <div class="group-review">
            ...
            <div class="box-review">
                <form class="group-input-review" id="reviewForm"
                    @if (auth()->check()) action="{{ route('reviews.store', $hotel->hotel_id) }}" method="POST" enctype="multipart/form-data"
                @else action="javascript:void(0)" onclick="showLoginModal()" @endif>
                    ...
                    <div class="group-text-review">
                        <textarea name="comment" id="inputReview" placeholder="Mời bạn nhập đánh giá..." class="form-control" required></textarea>
