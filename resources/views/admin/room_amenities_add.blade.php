    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <hr class="my-0" />
                <div class="card-body">
                    <form method="post" id="roomTypeForm" action="{{ route('admin.room_amenities.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                <label class="form-label">Name Room Amenties</label>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" name="description" id="descriptionRoomType" rows="3"></textarea>
                                @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
