...
<body>
    <div class="contact-container">
        ...
        <div class="contact-body">
            ...
            <!-- Form Liên Hệ -->
            <form class="contact-form" action="{{ route('contact') }}" method="post" onsubmit="return validateForm() && validateCaptcha()">
                ...
                <div style="display: flex; align-items: center;">
                    ...
                    <button type="button" onclick="generateCaptcha()" style="margin-left: 10px; background-color: #3498db; color: white; border: none; border-radius: 5px; padding: 10px;">
                        <i class="fas fa-sync-alt"></i>
                    </button>
                </div>
                <input type="text" id="captcha-input" placeholder="Nhập mã captcha" >
                <span id="captcha-error" style="color: red; display: none;">Mã captcha không đúng. Vui lòng thử lại.</span>
